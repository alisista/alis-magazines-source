...
class Index extends ComponentP {
  constructor(props) {
    super(props)
  ...
  drawMagazine(article) {
    ...
    let html = (
      <div className="col-md-6 col-xl-4">
        <div className="card">
          <Link
            as={`/${article.url_id || article.file_id}/`}
            href={`/articles/?id=${article.file_id}`}
          >
            <div
              style={{
                cursor: "pointer",
                height: "150px",
                backgroundImage: `url(${article.cover_image || profile_cover})`,
